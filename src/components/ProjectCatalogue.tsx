        ...
        <AnimatePresence>
            {isOpen && (
                ...
                >
                    ...
                    <div
                        className="relative w-full h-[50vh] md:h-[60vh] lg:h-[65vh] flex items-end pb-12 md:pb-20 px-6 md:px-16 bg-surface"
                    >
                        {/* Background Image */}
                    ...
                    <div className="px-6 md:px-16 pb-24 -mt-10 relative z-20">
